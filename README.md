...
Tested with Kubuntu 22.04 LTS, 23.10 and 24.04 LTS (should work with any distro) and 26.04 with four German (many more available) language models.
Should work on all other display managers (though not tested) other than KDE.
